...
def init_db():
    ...
    with _conn() as conn:
        ...
        _migrar_columna(conn, "horarios_personal", "lunes_salida",     "TEXT")
        _migrar_columna(conn, "horarios_personal", "martes_salida",    "TEXT")
        _migrar_columna(conn, "horarios_personal", "miercoles_salida", "TEXT")
        _migrar_columna(conn, "horarios_personal", "jueves_salida",    "TEXT")
        _migrar_columna(conn, "horarios_personal", "viernes_salida",   "TEXT")
        _migrar_columna(conn, "horarios_personal", "sabado_salida",    "TEXT")
        _migrar_columna(conn, "horarios_personal", "domingo_salida",   "TEXT")
        _migrar_columna(conn, "horarios_personal", "lunes_almuerzo_min",     "INTEGER")
        _migrar_columna(conn, "horarios_personal", "martes_almuerzo_min",    "INTEGER")
        _migrar_columna(conn, "horarios_personal", "miercoles_almuerzo_min", "INTEGER")
        _migrar_columna(conn, "horarios_personal", "jueves_almuerzo_min",    "INTEGER")
        _migrar_columna(conn, "horarios_personal", "viernes_almuerzo_min",   "INTEGER")
        _migrar_columna(conn, "horarios_personal", "sabado_almuerzo_min",    "INTEGER")
        _migrar_columna(conn, "horarios_personal", "domingo_almuerzo_min",   "INTEGER")
