"""
Generador de reportes DOCX (`app.domain.report_docx`).

Genera archivos `.docx` con portada, datos de asistencia por persona,
tablas de resumen y estilos corporativos.

Migrado desde `script_docx.py` (raíz) en Fase 4e.2 del ADR-0001.

API pública:
  - `generar_docx(...)`         — reporte grupal de periodo
  - `generar_docx_persona(...)` — reporte individual de persona
"""
