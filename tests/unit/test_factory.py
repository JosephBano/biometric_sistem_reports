...
class TestBlueprintsRegistrados:
    ...
    def test_contamos_los_blueprints_esperados(self):
        """Debe haber exactamente 15 blueprints (incluidos horarios_gf y functional_groups)."""
        from app.web import all_blueprints
        assert len(all_blueprints) == 15, (
            f"Esperado 15 blueprints, encontrados {len(all_blueprints)}: "
    ...
    def test_nombres_de_blueprints_esperados(self):
        ...
        expected = {
            ...
            "horarios_gf", "functional_groups", "admin", "analytics", "system",
        }
